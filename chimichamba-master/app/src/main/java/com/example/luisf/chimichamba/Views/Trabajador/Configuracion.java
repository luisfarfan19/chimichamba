...
public class Configuracion extends AppCompatActivity implements Sender{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bGuardarTrabajador.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!profesion.equals("")&&!categoria.equals("")) {
                    ...
                    Log.d("USERfoto: ", String.valueOf(urlFoto));*/
                        ...
                        send2.execute("/Tupdate", "{\"datos\":" + trabajador1.toJson() + "}");//crear usuario->answerfromserver tipo 1
                        Toast toast = Toast.makeText(getApplicationContext(), "Datos guardados correctamente", Toast.LENGTH_LONG);
                        toast.show();
                    }else {
                    ...
                    Toast toast = Toast.makeText(getApplicationContext(),"Llena los datos de profesion y elige una categoria",Toast.LENGTH_LONG);
                    toast.show();
                }
                ...
                if(tipo == 1) { //confirmaciones crear editar borrar
                    Toast toast1 =
                            Toast.makeText(getApplicationContext(),
                                    "La información se actualizó exitosamente.", Toast.LENGTH_LONG);
                ...
                if(tipo == 2) { //json get
                    ...
                    if(res!=null){
                        try{
                            ...
                            Picasso.with(this).load(trabajador.getUrl_foto()).transform(new CircleTransform()).into(bCambiarFoto);
                ...
                if(tipo == 4) { //hay
                    ...
                    if(!ans7.equals("")) {
                        if (!ans7.equals("NO")) {//SI existe el trabajador
                            ...
                            Toast toast1 =
                                    Toast.makeText(getApplicationContext(),
                                            "Error el usuario no existe.", Toast.LENGTH_LONG);
